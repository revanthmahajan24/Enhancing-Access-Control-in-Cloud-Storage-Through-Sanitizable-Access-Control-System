...
<div class="login">
  <header class="login-header"><span class="text">OTP</span><span class="loader"></span></header>
  <form class="login-form" name="f1" action="Otpcheck" method="post" onsubmit="return validatte()">
    <input type="text" placeholder="OTP" class="login-input" name="username"/>
